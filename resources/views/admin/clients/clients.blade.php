@extends('admin.layouts.master', [
    'titre' => 'Nos clients',
    'nomPage' => 'Nos clients',
    'descriPage' => 'Le logo de tous les clients dont nous avons eu a travailler avec eux ',
])
                ...
                <div class="card">
                        ...
                        <div class="card-toolbar">
                            <div data-kt-user-table-toolbar="base">
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                    ...
                                    <i class="ki-duotone ki-plus fs-2"></i> Ajouter client
                                </button>
                            </div>
                                ...
                                <div class="modal-dialog modal-dialog-centered mw-650px">
                                    <div class="modal-content">
                                        <div class="modal-header" id="kt_modal_add_user_header">
                                            <h2 class="fw-bold">Ajouter d'un client</h2>
                                            ...
                                            <form id="kt_modal_add_user_form" class="form"
                                                ...
                                                <div class="d-flex flex-column scroll-y px-5 px-lg-10"
                                                    ...
                                                    <div class="fv-row mb-7">
                                                        <div class="form-text">205 x 60 px</div>
                                                        <style>
                    ...
                    <div class="card-body py-4 row">
                        @foreach ($clients as $list)
                            <div class="col-md-3 image-input image-input-outline image-input-placeholder"
                                data-kt-image-input="true">
                                <div class="image-input-wrapper w-125px h-125px"
                                    style="background-image: url({{ asset('clients') . '/' . $list->image_cli }});">
                                </div>
                                ...
                                <span class="btn btn-icon btn-circle btn-active-color-danger w-25px h-25px bg-body shadow"
                                    data-bs-toggle="tooltip" title="Supprimer le client">
                                    <i data-bs-toggle="modal" data-bs-target="#at_delete{{ $lsit->idcli }}"
                                        class="ki-duotone ki-cross fs-2" style="color: red"><span
                                            class="path1"></span><span class="path2"></span></i>
                                </span>
                                <div class="modal fade" id="at_delete{{ $lsit->idcli }}" tabindex="-1"
                                    aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered mw-650px">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body px-5 my-7">
                                                <form class="form" action="{{ route('clients.destroy', $list->idcli) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                    <div class="d-flex flex-column scroll-y px-5 px-lg-10"
                                                        ...
                                                        data-kt-scroll-offset="300px">
                                                        <div class="fv-row mb-7">
                                                            <h3 class="text-primary">Êtes-vous sûr de vouloir supprimer ?
                                                            </h3>
                                                        </div>
                                                    </div>
                                                    <div class="text-center pt-10">
