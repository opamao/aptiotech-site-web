                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body px-5 my-7">
                                            <form id="kt_modal_add_user_form" class="form"
                                                action="{{ route('slide.store') }}" enctype="multipart/form-data"
                                                method="POST">
                                                @csrf
                        ...
                        @foreach ($slides as $list)
                            <div class="image-input image-input-outline image-input-placeholder" data-kt-image-input="true">
                                <div class="image-input-wrapper"
                                    style="background-image: url({{ asset('slides') . '/' . $list->image_slide }}); height: 250px; width: 885px;">
                                </div>
                                ...
                                <span class="btn btn-icon btn-circle btn-active-color-danger w-25px h-25px bg-body shadow"
                                    ...
                                    <i data-bs-toggle="modal" data-bs-target="#at_delete" class="ki-duotone ki-cross fs-2"
                                        style="color: red"><span class="path1"></span><span class="path2"></span></i>
                                </span>
                                <div class="modal fade" id="at_delete" tabindex="-1" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered mw-650px">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body px-5 my-7">
                                                <form class="form" action="{{ route('slide.destroy', $list->idslide) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                    <div class="d-flex flex-column scroll-y px-5 px-lg-10"
