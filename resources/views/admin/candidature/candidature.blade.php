                    ...
                    <div class="card-body py-4">
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                            ...
                            <tbody class="text-gray-600 fw-semibold">
                                @foreach ($candidatures as $list)
                                    <tr>
                                        <td class="d-flex align-items-center">
                                            <div class="d-flex flex-column">
                                                <a href="#"
                                                    class="text-gray-800 text-hover-primary mb-1">{{ $list->nom_cand }}</a>
                                            </div>
                                        </td>
                                        <td>{{ $list->email_cand }} </td>
                                        <td>{{ $list->github_cand }} </td>
                                        <td>{{ $list->linkedin_cand }} </td>
                                        <td class="">
                                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                                data-bs-target="#at_view{{ $list->idcand }}">
                                                <i class="bi bi-eye fs-1x text-white">
                                                </i>
                                            </button>
                                            <div class="modal fade" id="at_view{{ $list->idcand }}" tabindex="-1"
                                                aria-hidden="true">
                                                            ...
                                                            <div class="d-flex flex-column scroll-y px-5 px-lg-10"
                                                                ...
                                                                <div class="fv-row mb-7">
                                                                    ...
                                                                    <div class="image-input image-input-outline image-input-placeholder"
                                                                        ...
                                                                        @endif
                                                                        <a class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow"
                                                                            data-kt-image-input-action="change"
                                                                            data-bs-toggle="tooltip" title="Télécharger"
                                                                            href="{{ asset('candidats') . '/' . $list->cv_cand }}"
                                                                            download>
                                            ...
                                            <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                                                data-bs-target="#at_delete{{ $list->idcand }}">
                                                <i class="bi bi-trash fs-1x text-white">
                                                </i>
                                            </button>
                                            <div class="modal fade" id="at_delete{{ $list->idcand }}" tabindex="-1"
                                                aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered mw-650px">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body px-5 my-7">
                                                            <form class="form"
                                                                action="{{ route('candidature.destroy', $list->idcand) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('DELETE')
                                                                <div class="d-flex flex-column scroll-y px-5 px-lg-10"
